  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">{t("app.root.notFound")}</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          {t("app.root.notFoundDesc")}
        </p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-semibold tracking-tight text-foreground">
          {t("app.root.errorTitle")}
        </h1>
        <p className="mt-2 text-sm text-muted-foreground">
          {t("app.root.errorDesc")}
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered career guidance. Personalized roadmaps, university matches, salary insights, and an always-on AI mentor." },
      { name: "author", content: "CareerAI" },
