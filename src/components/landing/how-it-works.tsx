      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="max-w-2xl mx-auto text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tight">
            {t("landing.features.titleA")} <span className="gradient-text">{t("landing.features.titleB")}</span>
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {steps.map((s, i) => (
            ...
            >
              ...
              <h3 className="text-lg font-semibold tracking-tight">{t(`landing.how.${s.key}.title`)}</h3>
              <p className="mt-2 text-sm text-muted-foreground leading-relaxed">{t(`landing.how.${s.key}.desc`)}</p>
            </motion.div>
          ))}
        </div>
      </div>
